      ...
      <div class="row">
        <section id="registration-form" class="inner-page borderTOP" style="text-align: justify;">
                ...
                <ul class="nav nav-tabs sh-tabs" id="myTab" role="tablist">
                  ...
                  <li class="nav-item">
                    ...
                    <?php } ?>
                      ...
                      <?php if (!empty($products['sample_report'])){ ?>   
                  <li class="nav-item">
          ...
          <div class="tab-content active" id="myTabContent">
            ...
            <div class="tab-pane fade" id="Description" style="min-height: 0px;">
              <div class="container">
                <div class="sh-overview-detail">
                  <h2>Descriptions</h2>
              ...
              <div class="container">
                <div class="sh-overview-detail">
                  ...
                  <?php 
                      ...
                      // print_r($products['user_manual']);exit;
...
<div class="modal-content">
  ...
  <div class="modal-body">
    <div class="row">
      ...
      <p>
        By tapping submit, you agree to Knowledge <a href="<?php echo  base_url().'privacy-policy'?>"> Privacy Policy </a> and <a href="<?php echo  base_url().'terms-of-service'?>#"> Tearms & Conditions </a>
      </p>
    </div>
    </div>
  </div>
