...
?>
  <head>
    ...
    <link rel="icon" href="<?php echo base_url()?>assets/csc/images/favicon.png">
    <title>Certifyhub - Home</title>
    
    <!-- <link href="<?php echo base_url()?>assets/csc/css/custom.css" rel="stylesheet"> -->
    <link href="<?php echo base_url()?>assets/csc/css/lib.css" rel="stylesheet">
    <link href="<?php echo base_url()?>assets/csc/css/style.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css" rel="stylesheet">
