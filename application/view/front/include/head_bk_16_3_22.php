                ...
                <ul class="sh-calltoaction">
                  <li>
                    <div class="dropdown">
                      ...
                      <i data-feather="phone"></i>  Call Free : <a href="tel:+91 9607009603" target="_blank">+91 9607009603</a> <span><i data-feather="chevron-down"></i> </span>
                      </button>
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                          ...
                          <ul>
                            <li> <a target="_blank" href="<?php echo base_url().'product/e-patraa/45'; ?>">E Patraa</a>
                            <li> <a target="_blank" href="<?php echo base_url().'product/dmarc-assure/43'; ?>">DMARC Assure</a>
                            <li> <a target="_blank" href="<?php echo base_url().'product/secure-edge-atp/44'; ?>">Secure Edge</a>
                            <li> <a target="_blank" href="<?php echo base_url().'product/xgen-plus--enterprise-email-solution/113'; ?>">Xgen Plus - Enterprise Email Solution</a>
                            <li> <a target="_blank" href="<?php echo base_url().'product/microsoft-365-for-business/81'; ?>">Microsoft 365 for Business</a>
                          </ul>
                          <h3> Passwordless & SSO </h3>
                          <ul>
                            <li> <a target="_blank" href="<?php echo base_url().'product/virtual-qr/64'; ?>">Virtual QR</a></li>
                            <li> <a target="_blank" href="<?php echo base_url().'product/miri-token-offline-otp/103'; ?>">MIRI Token Offline OTP</a></li>
                            <li> <a target="_blank" href="<?php echo base_url().'product/miri-id/104'; ?>">MIRI ID</a></li>
                            <li> <a target="_blank" href="<?php echo base_url().'product/miri-virtual-super-tokenized-card/105'; ?>">MIRI Virtual Super Tokenized Card</a></li>
                            <li> <a target="_blank" href="<?php echo base_url().'product/securias-visitor-management/106'; ?>">Securias Visitor Management </a></li>
                            <li> <a target="_blank" href="<?php echo base_url().'product/byfrost-single-sign-on/107'; ?>">BYFROST Single Sign On</a></li>
                          </ul>
                        </div>
                        <div class="col">
                          <h3>Endpoint Backup & Security</h3>
                          <ul>
                          <li> <a target="_blank" href="<?php echo base_url().'product/indefend-advanced/62'; ?>">inDefend Advanced</a></li>
                          <li> <a target="_blank" href="<?php echo base_url().'product/webroot-dns-protection/129'; ?>">Webroot DNS Protection</a></li>
                          <li> <a target="_blank" href="<?php echo base_url().'product/webroot-endpoint-security---anti-virus/128'; ?>">Webroot Endpoint Security - Anti Virus</a></li>
                          <li> <a target="_blank" href="<?php echo base_url().'product/webroot-security-awareness-training/130'; ?>">Webroot Security Awareness Training</a></li>
                          <li> <a target="_blank" href="<?php echo base_url().'product/carbonite-availability/125'; ?>">Carbonite Availability</a></li>
                          <li> <a target="_blank" href="<?php echo base_url().'product/carbonite-server-backup/123'; ?>">Carbonite Server Backup</a></li>
                          <li> <a target="_blank" href="<?php echo base_url().'product/carbonite-endpoint-backup/124'; ?>">Carbonite Endpoint Backup</a></li>

                          </ul>
                          <h3>ERP Solution</h3>
                          <ul>
                            <li> <a target="_blank" href="<?php echo base_url().'product/qad-adaptive-erp/88'; ?>">QAP ERP</a></li>
                          </ul>
                          <h3>Warehouse Management</h3>
                          <ul>
                            <li> <a target="_blank" href="<?php echo base_url().'product/pyrops/99'; ?>">PYROPS</a></li>
                          </ul>
                        ...
                        <div class="col">
                          ...
                          <ul>
                            <li><a target="_blank" href="<?php echo base_url().'product/enalytics/58'; ?>">eNalytics</a></li>
                            <li><a target="_blank" href="<?php echo base_url().'product/ensightics/61'; ?>">eNsightics</a></li>
                            <li><a target="_blank" href="<?php echo base_url().'product/smarten-augmented-analytics/42'; ?>">Smarten Augmented Analytics</a></li>
                            <li><a target="_blank" href="<?php echo base_url().'product/rubiscape---data-science-aiml-amp-analytics-simplified/112'; ?>">Rubiscape - Data Science, AI/ML & Analytics Simplified</a></li>
                          </ul>
                          <h3> OTT Platform</h3>
                          <ul>
                            <li> <a target="_blank" href="<?php echo base_url().'product/enlight-ott/116'; ?>">eNlight OTT</a></li>
                          </ul>
                          <h3> HRMS</h3>
                          <ul>
                            <li> <a target="_blank" href="<?php echo base_url().'product/ngage-continuous-employee-feedback/98'; ?>">n!Gage Continuous Employee Feedback</a></li>
                            <li> <a target="_blank" href="<?php echo base_url().'product/ncourage---rewards-amp-recognition-platform/100'; ?>">n!Courage 360 Feedback, Rewards and Recognition Platform</a></li>
                          </ul>
                        </div>
                        <div class="col">
                          <h3>Communication Platform</h3>
                          <ul>
                               <li> <a target="_blank" href="<?php echo base_url().'product/enlightbot/63'; ?>">eNlight BOT</a></li>
                               <li> <a target="_blank" href="<?php echo base_url().'product/jodo-video/89'; ?>">JODO Video</a></li>
                               <li> <a target="_blank" href="<?php echo base_url().'product/jodo-call/87'; ?>">JODO Call</a></li>
                               <li> <a target="_blank" href="<?php echo base_url().'product/jodo-basic/93'; ?>">JODO Basic</a></li>
                               <li> <a target="_blank" href="<?php echo base_url().'product/circleone-crm/71'; ?>">CircleOne CRM</a></li>
                               <li> <a target="_blank" href="<?php echo base_url().'product/invc---video-conferencing-platform/117'; ?>">inVC - Video Conferencing Platform</a></li>
                          </ul>
                          <h3> GRP</h3>
                          <ul>
                        ...
                        <div class="col-12 d-flex justify-content-center sh-btn-bottom">
                            <a target="_blank" href="<?php echo base_url().'products'; ?>"  class="hover-1 <?php echo $pactive; ?>" class="btn btn-primary">View All Products  <i data-feather="arrow-right"></i></a>
